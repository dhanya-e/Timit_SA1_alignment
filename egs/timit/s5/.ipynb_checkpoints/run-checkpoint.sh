...
timit=/home/dhanya/PhD/Datasets/TIMIT_orig
...
for x in train dev test; do
  ...
  apply-cmvn --utt2spk=ark:data/$x/utt2spk scp:data/$x/cmvn.scp scp:data/$x/feats.scp ark:- | add-deltas ark:- ark:data/$x.ark
  copy-feats ark:data/$x.ark ark,scp:data/$x/$x.ark,data/$x/$x.scp
done
